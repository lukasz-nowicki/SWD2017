...
//	}
	...
	public static void main(String[] args) {
		...
		final int GEN_SIZE=10;
		final double TOTAL_AVAILABLE_CAPACITY=20;
		final double[] bestGenCriteria = new double[3];
		List<Gen> resultSecondFunction = new ArrayList<Gen>();
		 final int selectCombination=0;
		String combination="";
		final JFrame frame;
		final JFrame frame2;
		final JFrame frame3;
		...
		final Generation generation = new Generation(POPULATION,GEN_SIZE,TOTAL_AVAILABLE_CAPACITY);
...
//		    System.out.println("1-VWC , 2-VCW, 3-WCV , 4-WVC, 5-CVW, 6-CWV Podaj wybor ->");
...
//		 
//		 System.out.println("Final result : "+generation.secondAlgorithm(selectCombination, bestGenCriteria).get(0));
//		
